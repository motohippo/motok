...
class Mage_Core_Block_Template extends Mage_Core_Block_Abstract
{
    ...
    public function fetchView($fileName)
    {
        ...
        if ($this->getShowTemplateHints()) {
            echo <<<HTML
<div class="template_hints_wrapper">
<a class="template_hints" title="{$fileName}" href="phpstorm://open?file={$this->_viewDir}/{$fileName}">$this->_template</a>
HTML;
            if (self::$_showTemplateHintsBlocks) {
                $thisClass = get_class($this);
                $classPath = mageFindClassFile($thisClass);
                echo <<<HTML
<a class="template_hints_block" title="{$thisClass}" href="phpstorm://open?file={$classPath}">{$thisClass}</a>
HTML;
            }
        }
